...
namespace WardrobeApplication.Controllers
{
    public class BottomsTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,NameBottom,Type,Color,Season,Occasion,Photo")] BottomsTable bottomsTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,NameBottom,Type,Color,Season,Occasion,Photo")] BottomsTable bottomsTable)
        {
            if (ModelState.IsValid)
            {
