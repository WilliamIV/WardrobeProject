...
namespace WardrobeApplication.Controllers
{
    public class TopsTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,NameTop,Type,Color,Season,Occasion,Photo")] TopsTable topsTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,NameTop,Type,Color,Season,Occasion,Photo")] TopsTable topsTable)
        {
            if (ModelState.IsValid)
            {
